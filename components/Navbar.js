    ...
    <>
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Newsreader', serif", fontSize: 18, fontWeight: 600, color: "#F2F2F2", whiteSpace: "nowrap" }}>
            Zilla Engine
          </span>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 10 }}>
          {ready && (
            authenticated ? (
              ...
              <>
                <button onClick={login} style={{ padding: "8px 16px", borderRadius: 8, background: "transparent", border: "1px solid rgba(192,192,192,0.3)", color: "#E6E6E6", cursor: "pointer", fontSize: 13, fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>
                  Sign In
                </button>
                <button onClick={login} style={{ padding: "8px 16px", borderRadius: 8, background: "linear-gradient(135deg,#E8E8E8,#B0B0B0)", border: "none", color: "#0A0A0A", cursor: "pointer", fontSize: 13, fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>
                  Sign Up
                </button>
              </>
            )
